-- Sound Royale Database Cleanup and Rebuild
-- This safely drops existing tables and recreates the complete schema

-- =====================================================
-- CLEANUP EXISTING PARTIAL SCHEMA
-- =====================================================
...
DO $$
BEGIN
  RAISE NOTICE 'Sound Royale database schema has been successfully created!';
  RAISE NOTICE 'Tables created: users, matches, audio_submissions, votes, handicaps';
  RAISE NOTICE 'Views created: leaderboard_competitors, leaderboard_spectators';
  RAISE NOTICE 'Storage bucket created: audio-submissions';
  RAISE NOTICE 'RLS policies and triggers configured successfully';
END $$;
