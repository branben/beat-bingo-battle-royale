-- Sound Royale Database Schema
-- This creates all tables, RLS policies, and storage setup needed for the app
...
-- INSERT INTO public.users (username, display_name, competitor_elo, spectator_elo, games_played, games_won)
-- VALUES 
--   ('BeatMaster_2024', 'Beat Master', 1250, 1100, 23, 15),
--   ('RhythmKing', 'Rhythm King', 1180, 950, 22, 12),
--   ('SpectatorPro', 'Spectator Pro', 500, 1500, 0, 0);
